...
function Details() {
    return (
        <Row md={2}>
            <Col>
                <div className={styles.icons}><FontAwesomeIcon icon={faEnvelopeOpenText} /></div>
                ...
                <div className={styles.icons}><FontAwesomeIcon icon={faCalendarAlt} /></div>
            ...
            <Col>
                <div className={styles.icons} ><FontAwesomeIcon icon={faFlag} /></div>
                ...
                <div className={styles.icons}><FontAwesomeIcon icon={faFileInvoiceDollar} /></div>
